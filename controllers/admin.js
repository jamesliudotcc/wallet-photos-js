...
router.get('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var user, allUsers, currentUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userRepository.findOne(req.session.passport.user)];
            case 1:
                user = _a.sent();
                return [4 /*yield*/, userRepository.find({ order: { id: 'ASC' } })];
            case 2:
                allUsers = _a.sent();
...
router.post('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var user, numberOfAdmins;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userRepository.findOne(req.body.userId)];
            case 1:
                user = _a.sent();
                return [4 /*yield*/, userRepository.count({ where: { admin: true } })];
            case 2:
